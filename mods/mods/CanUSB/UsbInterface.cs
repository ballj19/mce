...
namespace CanUsbInterface
{
     ...
     *  riiin\r,          Riiiiiiiin\r                -> Z\r or \b (Remote Transmission Request (RTR) standard, Remote Transmission Request (RTR) extended)
    ...
    public class CanUsbAdaptor
    {
        ...
        private const UInt32 CanUsbPIDVID_old = 0x0403FFA8;
        private const UInt32 CanUsbPIDVID = 0x04036001;
                        ...
                        for (UInt32 i = 0; i < numPorts; i++)
                        {
                            ...
                            if (ftdiDeviceList[i] != null)
                            {
                                ...
                                if (((ftdiDeviceList[i].Flags & FTDI.FT_FLAGS.FT_FLAGS_OPENED) == 0x00) &&
                                    ((ftdiDeviceList[i].ID == CanUsbPIDVID_old) || (ftdiDeviceList[i].ID == CanUsbPIDVID)) &&
                                    (ftdiDeviceList[i].Description == "CANUSB"))
                                {
