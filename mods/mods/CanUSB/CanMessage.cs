...
namespace CanUsbComponent
{
    ...
    public class CanMessage
    {
        ...
        public bool RTR; // Remote Transmission Request
        ...
        public CanMessage(CanMode local_Mode, bool rtrflag, UInt32 local_Id, int local_length, UInt64 local_Data)
        {
            Mode = local_Mode;
            RTR = rtrflag;
            Id = local_Id;
        ...
        // Construct a CAN message
        public CanMessage(CanMode local_Mode, bool rtrflag, UInt32 local_Id, byte[] local_Data)
        {
            Mode = local_Mode;
            RTR = rtrflag;
            Id = local_Id;
        ...
        public override string ToString()
        {
            ...
            {
                id = String.Format("ID:{0:X8} (SID:{1:X3} EID:{2:X5})", Id, ((Id >> 18) & 0x7FF), (Id & 0x3FFFF));
            }
            // Data
            if (RTR)
            {
